...
let SocketGateway = SocketGateway_1 = class SocketGateway {
    constructor(lastService, kungService, bellService, socketService, guard, config) {
    ...
    async handleConnection(client) {
        try {
            ...
            if (this.currentConnections >= this.MAX_CONNECTIONS) {
                this.logger.warn(`Connection rejected - Max connections reached: ${client.id}`);
                client.emit('full', {
    ...
    async handleDisconnect(client) {
        try {
            ...
            const roomId = this.user[client.id]
                ...
                : undefined;
            if (roomId) {
                this.logger.log(`Client disconnecting from room ${roomId}: ${client.id}`);
            ...
            this.logger.error(`Disconnect error for client ${client.id}: ${error.message}`, error.stack);
            try {
                this.currentConnections--;
                delete this.user[client.id];
                this.server.emit('list', this.user);
                ...
                this.logger.error(`Additional cleanup error: ${cleanupError.message}`, cleanupError.stack);
            }
        }
    }
    handlePing(roomId) {
    ...
    async handleMessage({ roomId, chat, roundTime, score, success }, client) {
        const isGameTurn = this.roomInfo[roomId].start &&
        ...
        await this.handleGameMessage(roomId, { chat, roundTime, score, success }, client);
    }
    async handleGameMessage(roomId, messageData, client) {
        ...
        try {
            this.logger.debug(`Processing game message - Room: ${roomId}, Type: ${gameType}`);
            switch (gameType) {
                case 0:
            ...
            this.logger.error(`Game message error - Room: ${roomId}, Type: ${gameType}`, error.stack);
        }
        finally {
    ...
    handleExitTeam(roomId, client) {
        const teams = ['woo', 'gomem', 'academy', 'isedol'];
        teams.forEach((team) => {
            const userIndex = this.game[roomId].team[team].findIndex((userId) => userId === this.user[client.id].id);
            if (userIndex !== -1) {
    ...
    handleReady(roomId, client) {
        ...
        if (index === -1) {
            const user = this.roomInfo[roomId].users.find((user) => user.id === this.user[client.id].id);
    ...
    async handleLastStart(roomId, client) {
        try {
            ...
            if (this.game[roomId].users.length + 1 !==
            ...
            this.game[roomId].option = this.socketService.getOption(this.roomInfo[roomId].option);
            this.game[roomId].roundTime = this.roomInfo[roomId].time;
            await this.lastService.handleStart(roomId, this.roomInfo[roomId], this.game[roomId]);
        }
        catch (error) {
    ...
    async handleLastRound(roomId) {
        try {
            await this.lastService.handleRound(roomId, this.roomInfo[roomId], this.game[roomId]);
        }
        catch (error) {
    ...
    async handleLastAnswer({ roomId, chat, roundTime, score, success }) {
        ...
        this.game[roomId].turnTime = this.socketService.getTurnTime(roundTime, this.game[roomId].chain);
        ...
        if (success) {
            ...
            const check = await this.socketService.check(chat, this.game[roomId].option);
            if (check.success) {
                score = this.socketService.checkWakta(check.word.wakta)
                    ? score * 1.58
                    : score;
                const mission = await this.lastService.handleCheckMission(chat, this.game[roomId]);
    ...
    handleKungRound(roomId) {
        this.kungService.handleRound(roomId, this.roomInfo[roomId], this.game[roomId]);
    }
    ...
    async handleBellStart(roomId, client) {
        try {
            ...
            this.handleReady(roomId, client);
            await this.bellService.handleStart(roomId, this.roomInfo[roomId], this.game[roomId]);
        }
        catch (error) {
    ...
    async handleBellRound(roomId) {
        try {
            await this.bellService.handleRound(roomId, this.roomInfo[roomId], this.game[roomId]);
        }
        catch (error) {
    ...
    handleBellAnswer({ roomId, score, }, client) {
        try {
            ...
            const idx = this.game[roomId].users.findIndex((user) => user.userId === this.user[client.id].id);
            if (idx === -1) {
                this.logger.warn(`User not found in room ${roomId}`);
                return;
            }
            this.bellService.handleAnswer(idx, this.game[roomId], score);
            const count = this.game[roomId].users.filter((user) => user.success === true);
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handlePong", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleUserList", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleLobbyChat", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleUpdate", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, socket_io_1.Socket]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleChangeHost", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, socket_io_1.Socket]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleTeam", null);
__decorate([
    __param(0, (0, websockets_1.MessageBody)()),
    __param(1, (0, websockets_1.ConnectedSocket)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, socket_io_1.Socket]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleExitTeam", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, socket_io_1.Socket]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleExitReady", null);
__decorate([
    __param(0, (0, websockets_1.MessageBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleHostReady", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, socket_io_1.Socket]),
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleLastStart", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleLastRound", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleLastAnswer", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleKTurnStart", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleKTurnEnd", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, socket_io_1.Socket]),
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleBellStart", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleBellRound", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleBellPing", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleBellPong", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleBellRoundStart", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleBellRoundEnd", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, socket_io_1.Socket]),
    __metadata("design:returntype", void 0)
], SocketGateway.prototype, "handleBellAnswer", null);
exports.SocketGateway = SocketGateway = SocketGateway_1 = __decorate([
    ...
    __param(0, (0, common_1.Inject)((0, common_1.forwardRef)(() => last_service_1.LastService))),
    __param(1, (0, common_1.Inject)((0, common_1.forwardRef)(() => kung_service_1.KungService))),
    __param(2, (0, common_1.Inject)((0, common_1.forwardRef)(() => bell_service_1.BellService))),
    __metadata("design:paramtypes", [last_service_1.LastService,
